...
def basicE_template(request):
    return render(request,"basicE.html")


def basicE_form_show(request):
    return render(request,"basicEresult.html")

def basicE_form_show2(request):
    return render(request,"basicEresult2.html")


def basicE_form_show3(request):
    return render(request,"basicEresult3.html")

def basicE_form_show4(request):
    return render(request,"basicEresult4.html")

def basicE_form(request):
    ...
    return render(request,'basicEresult.html',payload)


def basicE_form2(request):
    sagidict=sagilist()
    hisagidict=hisagilist()
    data=request.POST.get("hidden_data")
    ...
    return render(request,'basicEresult2.html',payload)

def basicE_form4(request):
    sagilistA=sagilist()
    ...
    return render(request,'basicEresult4.html',payload)
